...
const About = () => {
  ...
  const team = [
    { name: 'John Anderson', role: 'CEO & Founder', image: '👨‍💼' },
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-lg text-neutral-600 leading-relaxed">
                <p>
                  Founded in 1998, Prestige Build Construction Co. began with a simple mission: to deliver exceptional construction services with unwavering commitment to quality and client satisfaction.
                </p>
                <p>
                  Over the past 25 years, we've grown from a small team of dedicated professionals to one of the region's most trusted construction companies. Our portfolio includes hundreds of successful projects, from custom homes to large-scale commercial developments.
                </p>
                <p>
